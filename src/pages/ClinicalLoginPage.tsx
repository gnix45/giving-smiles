...
export const ClinicalLoginPage = () => {
      ...
      <div className="max-w-4xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl font-headline font-extrabold text-on-surface tracking-tight leading-tight">
            Welcome to the <br/><span className="text-primary">Clinical Portal.</span>
          </h1>
          <p className="text-on-surface-variant text-lg leading-relaxed max-w-md">
            Secure access for authorized medical personnel to manage logistics, matches, and patient care.
          </p>
        ...
        >
          <div className="space-y-2">
            <h2 className="text-2xl font-headline font-bold text-on-surface">Provider Access</h2>
            <p className="text-sm text-on-surface-variant">Authenticate to access the clinical system.</p>
          </div>

          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              <label className="text-xs font-bold text-on-surface-variant uppercase tracking-widest ml-2">Provider ID / NPI</label>
              <input 
                type="text" 
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between ml-2">
                <label className="text-xs font-bold text-on-surface-variant uppercase tracking-widest">Secure Password</label>
          ...
          <div className="text-center pt-4 border-t border-surface-container">
            <p className="text-xs text-on-surface-variant">
              Need access? <a href="#" className="text-primary font-bold hover:underline">Contact System Admin</a>
            </p>
          </div>
        </motion.div>
      </div>
