      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-surface-container">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-8 py-4">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            <a href="#" className="text-primary border-b-2 border-primary pb-1 font-headline font-bold">Impact</a>
            <a href="#" className="text-slate-500 hover:text-primary font-headline font-bold transition-colors">Legacy</a>
            <a href="#" className="text-slate-500 hover:text-primary font-headline font-bold transition-colors">Support</a>
            <a href="#" className="text-slate-500 hover:text-primary font-headline font-bold transition-colors">Logistics</a>
          </div>
          <div className="flex items-center space-x-2 md:space-x-4">
            <Link to="/login" className="hidden sm:block text-slate-500 font-headline font-bold hover:text-primary transition-colors">Login</Link>
            <Link to="/join" className="bg-primary text-white px-4 py-2 md:px-6 md:py-2.5 rounded-full font-headline font-bold text-sm md:text-base shadow-lg shadow-primary/10 active:scale-95 transition-all">
              Join Registry
            </Link>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/join" className="bg-primary text-white px-8 md:px-10 py-3 md:py-4 rounded-full font-headline font-bold text-base md:text-lg shadow-xl shadow-primary/20 hover:opacity-90 transition-all text-center">
                  Start Your Journey
                </Link>
                <button className="bg-surface-container-high text-primary px-8 md:px-10 py-3 md:py-4 rounded-full font-headline font-bold text-base md:text-lg hover:bg-surface-container-highest transition-all">
                  Get Help Now
                </button>
              </div>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
              {[
                ...
                { icon: Users, value: '85.2k', label: 'Active Donors' },
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-12 md:gap-20 items-start">
              <div className="lg:w-1/3">
                ...
                <a href="#" className="text-tertiary font-bold flex items-center gap-2 group hover:underline">
          ...
          <div className="max-w-5xl mx-auto px-6 md:px-8">
            <div className="bg-primary rounded-[2.5rem] p-8 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-primary/20">
              ...
              <div className="relative z-10">
                <h2 className="font-headline text-3xl md:text-5xl font-extrabold text-white mb-6 md:mb-8">Ready to leave a legacy?</h2>
                <p className="text-white/80 text-base md:text-xl max-w-2xl mx-auto mb-8 md:mb-12">
                  Joining the registry takes less than 2 minutes. Your decision today can save up to eight lives.
                </p>
                <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6">
                  <Link to="/join" className="bg-tertiary text-white px-8 md:px-12 py-4 md:py-5 rounded-full font-headline font-bold text-lg md:text-xl hover:scale-105 transition-transform shadow-xl text-center">
                    Register Now
                  </Link>
                  <button className="bg-white/10 backdrop-blur-md text-white border border-white/20 px-8 md:px-12 py-4 md:py-5 rounded-full font-headline font-bold text-lg md:text-xl hover:bg-white/20 transition-all">
                    How it Works
                  </button>
                </div>
              </div>
      ...
      <footer className="bg-surface-container-low py-12 px-8 border-t border-surface-container">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4">
          ...
          <div className="flex flex-wrap gap-4 md:gap-6 justify-center md:justify-start">
            {['Privacy Policy', 'Donor Rights', 'Contact Support', 'Medical Ethics'].map(link => (
              <a key={link} href="#" className="text-xs text-slate-500 hover:text-tertiary transition-colors">{link}</a>
            ))}
          </div>
