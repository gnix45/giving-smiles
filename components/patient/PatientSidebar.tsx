...
export function PatientSidebar({ isOpen, setIsOpen }: PatientSidebarProps) {
    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className="mb-6 px-4 py-2 flex items-center justify-between">
          <div>
            <h1 className="text-lg font-black text-primary font-headline">Patient Portal</h1>
            <p className="text-[10px] text-slate-500 font-medium tracking-widest uppercase">Giving Smiles</p>
          </div>
          <button 
        ...
        <div className="pt-4 mt-4 border-t border-surface-container shrink-0">
          <div className="flex items-center justify-between p-2 bg-surface-container-low rounded-xl border border-surface-container line-clamp-1">
            <div className="flex items-center space-x-3 truncate">
              <div className="w-10 h-10 rounded-full bg-slate-200 overflow-hidden shrink-0 relative">
                 <Image 
                  src={profile?.avatar_url || "https://picsum.photos/seed/patient/100/100"} 
                  alt="Profile" 
                  fill
              ...
              <div className="truncate">
                ...
                <p className="text-[10px] text-on-surface-variant truncate uppercase tracking-wider">
                  ID: #{profile?.id?.substring(0,6) || 'N/A'}
                </p>
              </div>
            </div>
          </div>
